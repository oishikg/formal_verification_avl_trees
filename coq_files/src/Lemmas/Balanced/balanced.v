...
(** Lemma to show that given a balanced [triple], its constituent 
[heightened_binary_tree]s should also be balanced *)
...
(* Lemma to show that given that:
   - an element is inserted in the right sub-tree of a given tree
   - the insertion does not unbalance the tree, 
  the heights of the left sub-tree and the new right sub-tree differ by at most one *)
...
(* Lemma to show that given that:
   - an element is inserted in the left sub-tree of a given tree
   - the insertion does not unbalance the tree, 
  the heights of the right sub-tree and the new left sub-tree differ by at most one *)
...
(** The following 4 lemmas, [rotate_right_differ_by_one_1], 
[rotate_right_differ_by_one_2], [rotate_right_differ_by_one_3], and
[rotate_right_differ_by_one_4], are helper lemmas to prove that right rotations
...
(** The following 4 lemmas, [rotate_left_differ_by_one_1], 
[rotate_left_differ_by_one_2], [rotate_left_differ_by_one_3], and
[rotate_left_differ_by_one_4], are helper lemmas to prove that left rotations
preserve balance. They deal with very specific propositions that must be proved to
prove the main balanced preservation theorem, and as such involve tedious but routine
arithmetic rewrites *)
